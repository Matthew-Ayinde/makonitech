    ...
    <section className="hero">
      ...
      <ScrollAnimation animateIn="fadeIn" duration={.8} delay={400} animateOnce={true}>
         ...
         <p className="mb30"><small>Last updated: April 04, 2022</small></p>
          <h3><strong>Privacy Policy for My Website</strong></h3>
          ...
          <p><strong>Privacy and Web Beacons</strong></p>
          <p>Like any other website, My Website uses "Privacy". These Privacy are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
          <p><strong>DoubleClick DART Cookie</strong></p>
          <p>Google is one of a third-party vendor on our site. It also uses Privacy, known as DART Privacy, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART Privacy by visiting the Google ad and content network Privacy Policy at the following URL &ndash; <a href="https://policies.google.com/technologies/ads"><span class="s1">https://policies.google.com/technologies/ads</span></a><span class="Apple-converted-space">&</span></p>
          <p>Some of advertisers on our site may use Privacy and web beacons. Our advertising partners are listed below. Each of our advertising partners has their own Privacy Policy for their policies on user data. For easier access, we hyperlinked to their Privacy Policies below.</p>
          <ul>
          ...
          <p>Third-party ad servers or ad networks uses technologies like Privacy, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on&My Website, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>
          <p>Note that My Website has no access to or control over these Privacy that are used by third-party advertisers.</p>
          ...
          <p>You can choose to disable Privacy through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers' respective websites. <a href="https://www.Privacypolicygenerator.info/privacy-policy-privacy-clauses/"><span class="s1">What Are Privacy?</span></a></p>
