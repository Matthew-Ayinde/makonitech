      ...
      <div className='security_hero'>
        <div className= "videoSection">
          <video
            ...
            // controls
            alt="All the devices"
            src={"https://makoni-website-videos.s3.amazonaws.com/CloudAdoption1Compressed.mp4"}
            ref={videoEl}
            type="video/mp4"
          />
          <div className={`hero-wrapper slideWrappervideo`}>
            ...
            <div className={`related-cs`}>
              <div>
                ...
                <ul>
                  <li><a style={{color:'#fff'}} href='/aws-cloud-services'>AWS Cloud Services</a></li>
                  <li><a style={{color:'#fff'}} href='/azure-cloud-services'>Azure Cloud Services</a></li>
                </ul>
              </div>
            </div>
          </div>
